...
%saveas(gcf, "CW1_Images/fd001_002_epipoles.eps", "epsc");
...
line(points(:,[1,3])',points(:,[2,4])');
%saveas(gcf, "CW1_Images/fd003_004_epipoles.eps", "epsc");
